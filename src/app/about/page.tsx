          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Since 2015, Nourish Bangladesh has been at the forefront of transforming 
                the agricultural landscape of Bangladesh. We are committed to providing 
                sustainable, high-quality solutions that nourish communities and support 
                economic growth.
              </p>
            </motion.div>
